...
const apiLink:string = "https://opentdb.com/api.php?amount=10&category=28&difficulty=easy&type=multiple"
...
let startQuiz = async () => {
    ...
    for (let i = 1; i < 10;i++){
        ...
        }else{console.log(chalk.red.bold.italic("Your Answer Is Wrong!"),chalk.blue.bold(`Correct Answer is ${data[i].correct_answer}`));
        }
    }
